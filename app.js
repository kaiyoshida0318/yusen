...
let state = { rows: [], categories: DEFAULT_CATEGORIES.slice(), statuses: DEFAULT_STATUSES.slice(), rakutenStatuses: DEFAULT_RAKUTEN_STATUSES.slice(), yahooStatuses: DEFAULT_YAHOO_STATUSES.slice(), markColors: {} };
...
function loadData(){
  ...
  state = { rows: [], categories: DEFAULT_CATEGORIES.slice(), statuses: DEFAULT_STATUSES.slice(), rakutenStatuses: DEFAULT_RAKUTEN_STATUSES.slice(), yahooStatuses: DEFAULT_YAHOO_STATUSES.slice(), markColors: {} };
}
...
function renderStatusManager(){
  ...
  [["status","商品状態"],["rakuten","楽天"],["yahoo","Yahoo"],["marks","マーク作成"]].forEach(([id,lbl])=>{
    const b = document.createElement("button");
