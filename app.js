...
const DEFAULT_STATUSES = [
  { id:"buy",       label:"買付前・済", icon:"num:1" },
  { id:"arrived",   label:"到着分",     icon:"num:2" },
  { id:"prearrive", label:"到着前",     icon:"num:3" },
  { id:"working",   label:"着手中",     icon:"num:4" },
  { id:"done",      label:"完了分" },
];
...
function isNumIcon(icon){ return typeof icon==="string" && /^num:[1-4]$/.test(icon); }
